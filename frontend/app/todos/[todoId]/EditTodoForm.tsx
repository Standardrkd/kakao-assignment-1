...
export default function EditTodoForm({ todo }: { todo: any }) {
    ...
    return (
        <div className="max-w-2xl mx-auto p-8 mt-10 bg-white rounded-2xl shadow-[0_10px_15px_-3px_rgba(103,43,224,0.08)] border border-gray-100">
            <h1 className="text-[2.2rem] font-bold mb-8 text-center text-purple-700 tracking-tight">할 일 수정</h1>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div className="flex gap-3 justify-end mt-2">
                    ...
                    <button type="submit" className="px-8 py-3 bg-[#ecfdf5] text-[#10b981] font-bold rounded-lg hover:bg-[#10b981] hover:text-white transition-colors">
                        저장하기
                    </button>
                </div>
            </form>
